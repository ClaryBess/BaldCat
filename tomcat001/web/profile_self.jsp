            ...
            <div class="navigation">
                <div id="menu" class="fix-fish-menu clearfix">
                    <ul id="nav" class="sf-menu">
                        ...
                        <li class="active"><a href="profile_self.jsp">个人空间</a></li>
    ...
    <div class="row entry-blog">
        <div class="span9">
            ...
            <%
                ...
                List<Blog> blogs=handler.blogsOfUser(user.getUserID().toString());
                List<User> follows=handler.myFollow(user.getUserID());
            ...
            <div class="row entry-post">
                <div class="span4">
                    <div class="entry-meta clearfix">
                        <span><strong><i class="icon-comment"></i> 评论：</strong> <a>${blog.commentNumber}</a></span>
                        <span><strong><i class="icon-heart"></i> 点赞：</strong> <a>${blog.likeNumber}</a></span>
        ...
        <div class="span3 sidebar">
            ...
            <div class="entry-meta clearfix">
                <span><strong><i class="icon-user"></i> 用户名：</strong> <a>${user.name}</a></span>
                <span><strong><i class="icon-comment"></i>性别：</strong> <a>${user.printGender()}</a></span>
                <span><strong><i class="icon-comment"></i>生日：</strong> <a>${user.birthday}</a></span>
                <span><strong><i class="icon-comment"></i> 粉丝数：</strong> <a>${user.getFansNumber()}</a></span>
            ...
            <div class="widget well">
                <h5>个人签名</h5>
                <p class="last">${user.introduction}</p>
                <p></p>
                <a class="btn" href="info.jsp">👀 查看个人信息 </a>
            </div><!-- .widget -->
