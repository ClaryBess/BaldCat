...
<header>
    ...
    <div class="row">
        <div class="logo">
            <a href="index_afterLogin.jsp"><img src="img/logo.png" alt="" /></a>
        </div><!-- logo -->
        <div class="navigation">
            <div id="menu-log" class="fix-fish-menu clearfix">
                <ul id="nav" class="sf-menu" style="margin-left: 0">
                    <li class="active"><a href="index_afterLogin.jsp">首页</a></li>
            ...
            <div class="col-sm-8 tab-content tab-content_mob-p0">
                <div role="tabpanel" class="tab-pane fade in active" id="home">
                    ...
                    <div class="header_news_text tab-pane__block">
                        ...
                        <a class="tab-pane__title" href="postL?BlogID=${blogs.get(0).blogID}">${blogs.get(0).title}</a>
                ...
                <div role="tabpanel" class="tab-pane fade" id="profile">
                    ...
                    <div class="header_news_text tab-pane__block">
                        ...
                        <a class="tab-pane__title" href="postL?BlogID=${blogs.get(1).blogID}">${blogs.get(1).title}</a>
                ...
                <div role="tabpanel" class="tab-pane fade" id="messages">
                    ...
                    <div class="header_news_text tab-pane__block">
                        ...
                        <a class="tab-pane__title" href="postL?BlogID=${blogs.get(2).blogID}">${blogs.get(2).title}</a>
                ...
                <div role="tabpanel" class="tab-pane fade" id="settings">
                    ...
                    <div class="header_news_text tab-pane__block">
                        ...
                        <a class="tab-pane__title" href="postL?BlogID=${blogs.get(3).blogID}">${blogs.get(3).title}</a>
                    ...
                    <div class="thumbnail thumbnail_big">
                        ...
                        <div class="caption thumbnail__caption">
                            <div class="news caption__news">
                                ...
                                <a href="postL?BlogID=${blogs.get(4).blogID}" class="news__head">${blogs.get(4).title}</a>
                    ...
                    <div class="thumbnail thumbnail_small">
                        ...
                        <div class="caption thumbnail__caption">
                            <div class="news caption__news">
                                ...
                                <a href="postL?BlogID=${blogs.get(5).blogID}" class="news__link">
                    ...
                    <div class="thumbnail thumbnail_small">
                        ...
                        <div class="caption thumbnail__caption">
                            <div class="news caption__news">
                                ...
                                <a href="postL?BlogID=${blogs.get(7).blogID}" class="news__link">
                    ...
                    <div class="thumbnail thumbnail_small">
                        ...
                        <div class="caption thumbnail__caption">
                            <div class="news caption__news">
                                ...
                                <a href="postL?BlogID=${blogs.get(8).blogID}" class="news__link">
                    ...
                    <div class="thumbnail thumbnail_small">
                        ...
                        <div class="caption thumbnail__caption">
                            <div class="news caption__news">
                                ...
                                <a href="postL?BlogID=${blogs1.get(0).blogID}" class="news__link">
                    ...
                    <div class="thumbnail thumbnail_small">
                        ...
                        <div class="caption thumbnail__caption">
                            <div class="news caption__news">
                                ...
                                <a href="postL?BlogID=${blogs1.get(1).blogID}" class="news__link">
                    ...
                    <div class="thumbnail thumbnail_small">
                        ...
                        <div class="caption thumbnail__caption">
                            <div class="news caption__news">
                                ...
                                <a href="postL?BlogID=${blogs1.get(2).blogID}" class="news__link">
                    ...
                    <div class="thumbnail thumbnail_small">
                        ...
                        <div class="caption thumbnail__caption">
                            <div class="news caption__news">
                                ...
                                <a href="postL?BlogID=${blogs1.get(3).blogID}" class="news__link">
                        ...
                        <div class="thumbnail thumbnail_small">
                            ...
                            <div class="caption thumbnail__caption">
                                <div class="news caption__news">
                                    ...
                                    <a href="postL?BlogID=${blogs2.get(0).blogID}" class="news__link">
                        ...
                        <div class="thumbnail thumbnail_small">
                            ...
                            <div class="caption thumbnail__caption">
                                <div class="news caption__news">
                                    ...
                                    <a href="postL?BlogID=${blogs2.get(1).blogID}" class="news__link">
                        ...
                        <div class="thumbnail thumbnail_small">
                            ...
                            <div class="caption thumbnail__caption">
                                <div class="news caption__news">
                                    ...
                                    <a href="postL?BlogID=${blogs2.get(2).blogID}" class="news__link">
                        ...
                        <div class="thumbnail thumbnail_small">
                            ...
                            <div class="caption thumbnail__caption">
                                <div class="news caption__news">
                                    ...
                                    <a href="postL?BlogID=${blogs2.get(3).blogID}" class="news__link">
